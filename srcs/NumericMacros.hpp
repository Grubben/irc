...
//#define RPL_WHOREPLY(nickname, channel, username, hostname, servername, nickname, modes, realname) (":" SERVER_NAME " 352 " + nickname + " " + channel + " " + username + " " + hostname + " " + servername + " " + nickname + " " + modes + " :" + realname + "\r\n")
...
#define KICK(kicker, channel, kickee)           (":" + kicker + "!" + kicker + "@" + SERVER_NAME + " KICK " + channel + " " + kickee + " :" + kickee + "\r\n")
